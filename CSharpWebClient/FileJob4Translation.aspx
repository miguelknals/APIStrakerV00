    ...
    <form id="form1" runat="server">
        <div>
            <table>
                ...
                <tr>
                    <td>The translate/file method is a POST and is used<br />
&nbsp;to submit a new API file job. The parameter that<br />
&nbsp;must be passed is a source_file that follows the<br />
